...
description: "Description of the patron API flow."
---
...
The client sends an HTTP request to display the dish details at the designated endpoint, filtering the response to only the fields it needs to display on the dish’s details page.:
